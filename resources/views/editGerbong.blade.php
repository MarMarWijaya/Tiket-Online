<html>
    ...
    <div class="container">
        <div class="boxed" style="margin-top:11%; background-color:#0b56a7; border-radius: 15px; margin-left:22%; margin-right: 22%">
        <h3 style="text-align:center; color: white;"><br>Edit Data Gerbong</h3><br>
        <form method='post' action='/ubahGerbong' style="margin-left: 5%; margin-right: 5%">
            {{ csrf_field() }}
            @foreach($hasil as $h)
                <div class="form-group">
                    <label style="color: white; font-size: 19;">Tipe Kelas</label>
                    <input type='hidden' name='idKelas' value='{{ $h->idKelas }}'>
                    <input type='text' class="form-control" name='Kelas' value='{{ $h->Kelas }}' required>
                </div>
                <div class="form-group">
                    <label style="color: white; font-size: 19;">Harga</label>
                    <input type='text' class="form-control" name='Harga' value='{{ $h->Harga }}' required>
                </div>
                <div class="form-group">
