<html>
    ...
    <div class="container">
        ...
        <h3 style="text-align:center; color: white;"><br>Edit Data Stasiun</h3><br>
        <form method='post' action='/ubah' style="margin-left: 5%; margin-right: 5%">
            {{ csrf_field() }}
            @foreach($hasil as $h)
                <div class="form-group">
                    <label style="color: white; font-size: 19;">Nama Stasiun</label>
                    <input type='hidden' name='letak1' value='{{ $h->letak }}'>
                    <input type='text' class="form-control" name='letak2' value="{{ $h->letak}}"  required>
                </div>
                <div class="form-group">
